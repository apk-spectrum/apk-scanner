...
!define PROJECTNAMEANDVERSION "APK Scanner 2.3.2"
...
Section $(APP_NAME) Section1
	...
	File "release\lib\ForfindGUI.jar"
	...
	File "release\lib\rsyntaxtextarea-2.5.7.jar"
...
Section Uninstall
	...
	Delete "$INSTDIR\lib\ForfindGUI.jar"
	...
	Delete "$INSTDIR\lib\rsyntaxtextarea-2.5.7.jar"
