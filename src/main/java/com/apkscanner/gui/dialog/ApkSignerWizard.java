...
public class ApkSignerWizard implements ActionListener {
    ...
    private void initialize(Window window) {
        ...
        GridBagConstraints gridButtonConst = new GridBagConstraints(2, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0);
        ...
        if (ACT_CMD_SIGN_APK.equals(actCmd)) {
            ...
            new SwingWorker<String, Void>() {
                ...
                protected String doInBackground() throws Exception {
                    ...
                    return ApkSigner.signApk(pemFile.getAbsolutePath(), pk8File.getAbsolutePath(),
                            apkFilePath, destFile.getAbsolutePath());
                }
            ...
            if (ACT_CMD_PEM_EXPLOERE.equals(actCmd)) {
                ...
                jfc.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter(
                        "Privacy Enhanced Mail Security Certificate(.pem)", "pem"));
            } else if (ACT_CMD_PK8_EXPLOERE.equals(actCmd)) {
                jfc.setSelectedFile(new File(txtPk8FilePath.getText()));
                jfc.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter(
                        "Private key(.pk8)", "pk8"));
            }
            if (jfc.showOpenDialog(wizard) != JFileChooser.APPROVE_OPTION) return;
