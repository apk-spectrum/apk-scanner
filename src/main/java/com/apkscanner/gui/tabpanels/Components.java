...
public class Components extends AbstractTabbedPanel {
    ...
    public void initialize() {
        table = new JTable(tableModel = new CompTableModel(),
                new SimpleTableColumnModel(310, 50, 35, 35, 35, 35)) {
        ...
        table.setRowSorter(new TableRowSorter<TableModel>(tableModel) {
            {
                setRowFilter(new RowFilter<TableModel, Integer>() {
                    ...
                    public boolean include(Entry<? extends TableModel, ? extends Integer> entry) {
                        ...
                        String data =
                                (String) tableModel.getValueAt(entry.getIdentifier(), targetCol);
        ...
        textField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            private void setFilter() {
                ...
                if (row > -1)
                    curClass = (String) tableModel.getValueAt(table.convertRowIndexToModel(row), 0);
        ...
        String[] petStrings =
                {RConst.COMPONENT_FILTER_TYPE_XML, RConst.COMPONENT_FILTER_TYPE_CLASS};
        ...
        filterTypeCombobox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                RComp res = RConst.COMPONENT_FILTER_TYPE_XML.equals(fileType)
                        ? RComp.COMPONENT_FILTER_PROMPT_XML
                        : RComp.COMPONENT_FILTER_PROMPT_NAME;
                res.set(tp7);
    ...
    class CompTableModel extends SimpleTableModel {
        ...
        CompTableModel() {
            super(RStr.COMPONENT_COLUME_CLASS, RStr.COMPONENT_COLUME_TYPE,
                    RStr.COMPONENT_COLUME_ENABLED, RStr.COMPONENT_COLUME_EXPORT,
                    RStr.COMPONENT_COLUME_PERMISSION, RStr.COMPONENT_COLUME_STARTUP);
        }
            ...
            for (ComponentInfo info : infoList) {
                ...
                if (info.exported == null) {
                    if (info instanceof ProviderInfo) {
                        ...
                        exported = info.intentFilter != null && info.intentFilter.length > 0 ? "O"
                                : "X";
                    }
                } else {
                ...
                if (info instanceof ProviderInfo) {
                    ...
                    if (info.permission != null
                            || (pInfo.readPermission != null && pInfo.writePermission != null)) {
                        permission = "R/W";
                ...
                data.add(new Object[] {info.name, type, enabled, exported, permission, startUp,
                        info.xmlString});
            }
        }
