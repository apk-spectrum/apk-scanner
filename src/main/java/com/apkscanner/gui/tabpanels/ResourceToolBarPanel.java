...
public class ResourceToolBarPanel extends JPanel {
    ...
    public ResourceToolBarPanel(final ActionListener listener) {
        ...
        JButton openBtn =
                new JButton("", RImg.RESOURCE_TEXTVIEWER_TOOLBAR_OPEN.getImageIcon(16, 16));
        JButton saveBtn =
                new JButton("", RImg.RESOURCE_TEXTVIEWER_TOOLBAR_SAVE.getImageIcon(16, 16));
        ...
        JButton findBtn =
                new JButton("", RImg.RESOURCE_TEXTVIEWER_TOOLBAR_FIND.getImageIcon(16, 16));
        JButton nextBtn =
                new JButton("", RImg.RESOURCE_TEXTVIEWER_TOOLBAR_NEXT.getImageIcon(16, 16));
        JButton prevBtn =
                new JButton("", RImg.RESOURCE_TEXTVIEWER_TOOLBAR_PREV.getImageIcon(16, 16));
        ...
        multiLinePrintButton =
                new JToggleButton(RImg.RESOURCE_TEXTVIEWER_TOOLBAR_INDENT.getImageIcon());
        ...
        KeyStrokeAction.registerKeyStrokeAction(findtextField,
                KeyStroke.getKeyStroke(KeyEvent.VK_F3, 0), ResourceContentsPanel.ACT_CMD_FIND_NEXT,
                listener);
        KeyStrokeAction.registerKeyStrokeAction(findtextField,
                KeyStroke.getKeyStroke(KeyEvent.VK_F3, RConst.SHIFT_MASK),
                ResourceContentsPanel.ACT_CMD_FIND_PREV, listener);
    }
