...
public class EasyStartupDlg {
    ...
    static public boolean showAboutDialog(Component component) {
        ...
        style.append("background-color:#"
                + Integer.toHexString(label.getBackground().getRGB() & 0xFFFFFF) + ";");
        ...
        imagePanel.start();
        int x = JOptionPane.showOptionDialog(component, aboutPanel, RStr.BTN_CHECK_UPDATE.get(),
        ...
        // MessageBoxPane.showMessageDialog(component, aboutPanel, "Update",
        // MessageBoxPane.CLOSED_OPTION, null);
    }
