...
public class EasyToolbarSettingDnDDlg extends JDialog implements ActionListener {
    ...
    public EasyToolbarSettingDnDDlg(Frame frame, boolean modal) {
        ...
        showtoollist.addListSelectionListener(new ListSelectionListener() {
            @Override
            public void valueChanged(ListSelectionEvent e) {
                // ListSelectionModel lsm = (ListSelectionModel)e.getSource();
                if (showtoollist.getSelectedValue() != null) {
                    description.setText("*" + showtoollist.getSelectedValue().getTitle() + " : "
                            + showtoollist.getSelectedValue().getDescription());
                }
            }
        });


        JScrollPane showtoollistpane = new JScrollPane(showtoollist,
    ...
    class HideCellRenderer extends JLabel implements ListCellRenderer<Object> {
        ...
        public Component getListCellRendererComponent(JList<?> list, Object value, int index,
            ...
            setIcon(new ImageIcon(
                    ImageUtils.getScaledImage(entry.getImage(), this.height, this.height)));
