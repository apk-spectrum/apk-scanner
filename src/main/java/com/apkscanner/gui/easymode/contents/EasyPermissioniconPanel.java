...
public class EasyPermissioniconPanel extends RoundPanel implements ActionListener {
    ...
    private void init() {
        ...
        scrollPane = new JScrollPane(toolbartemppanel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
        ...
        scrollPane.addComponentListener(new ComponentListener() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                toolbartemppanel.setPreferredSize(
                        new Dimension(0, HEIGHT * (line + 1) + ((line != 0) ? SHADOW_SIZE : 0)));
            }
        ...
        btnshowpermissiondlg = new EasyRoundButton(ImageUtils.setcolorImage(
                RImg.EASY_WINDOW_PERMISSION_ICON.getImageIcon(20, 35), permissionbackgroundcolor));
        // btnshowpermissiondlg = new
        // EasyRoundButton(RImg.EASY_WINDOW_PERMISSION_ICON.getImageIcon(20, 35));
    ...
    public void setPermission(ApkInfo apkInfo) {
        ...
        boolean isPlatformSign =
                ApkInfoHelper.isTestPlatformSign(apkInfo) || ApkInfoHelper.isSamsungSign(apkInfo);
        clear();
        ...
        for (PermissionGroupInfoExt g : permissionManager.getPermissionGroups()) {
            ...
            try {
                ...
                btn.setPreferredSize(
                        new Dimension(HEIGHT - SHADOW_SIZE * 2, HEIGHT - SHADOW_SIZE * 2));
