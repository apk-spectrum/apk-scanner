    ...
    class AnimationTask extends TimerTask {
        ...
        public void run() {
            ...
            if (hoversize <= width || width <= originalsize) {
                if (eventlistner != null && entered)
                    eventlistner.changestate(EasyToolListner.STATE_ANIMATION_END, toolicon);
                this.cancel();
            }
        }
    };
            ...
            EventQueue.invokeLater(new Runnable() {
                ...
                public void run() {
                    actionlistener.actionPerformed(
                            new ActionEvent(EasyToolIcon.this, ActionEvent.ACTION_PERFORMED,
                                    ActionCmd, e.getWhen(), e.getModifiersEx()));
                }
            });
        }
    }
