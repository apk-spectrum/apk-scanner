...
public class EasyGuiMainPanel extends JPanel
    ...
    public EasyGuiMainPanel(JFrame mainframe, UiEventHandler eventHandler) {
        ...
        // dummy.add(new EasyButton(Resource.IMG_EASY_WINDOW_SPREAD.getImageIcon(35,35)),
        // BorderLayout.EAST);
    ...
    private void showApkinfopanel() {
        ...
        Log.d(" UI set 시간 : " + (System.currentTimeMillis() - EasyMainUI.UIstarttime) / 1000.0
                + "(start : " + simple.format(result));
    }
        ...
        public void onCompleted() {
            ...
            if (this.error == 0) {
                ...
                if (changed) {
                    ...
                    Log.d("Core 시간: "
                            + ((System.currentTimeMillis() - EasyMainUI.corestarttime) / 1000.0)
                            + "(core start : " + simple.format(result));
                }
                //////////////////////////////////// for test
