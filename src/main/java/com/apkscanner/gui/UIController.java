...
public class UIController implements Runnable, InvocationHandler {
        ...
        EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                if (lodingDlg == null && visible) {
                    ...
                    JLabel lodingLable = new JLabel("Waiting for ADB Server.",
                            RImg.RESOURCE_TREE_OPEN_JD_LOADING.getImageIcon(),
    ...
    public void changeGui(final String state) {
        ...
        final String apkPath =
                apkScanner.getApkInfo() != null ? apkScanner.getApkInfo().filePath : null;
    ...
    private void loadPlugIn() {
        PlugInManager.setAppPackage("com.apkscanner", RStr.APP_VERSION.get(), RStr.APP_NAME,
                RImg.APP_ICON);
    ...
    private void initMacApplication() {
        ...
        try {
            final Class<?> applicationClass =
                    Class.forName(isJdk9 ? "java.awt.Desktop" : "com.apple.eawt.Application");
            final Class<?> openFilesHandlerClass =
                    Class.forName(isJdk9 ? "java.awt.desktop.OpenFilesHandler"
                            : "com.apple.eawt.OpenFilesHandler");
            final Method getApplication =
                    applicationClass.getMethod(isJdk9 ? "getDesktop" : "getApplication");
            final Object application = getApplication.invoke(null);
            final Method setOpenFileHandler =
                    applicationClass.getMethod("setOpenFileHandler", openFilesHandlerClass);
            ...
            final Object openFilesHandlerObject = Proxy.newProxyInstance(
                    openFilesHandlerClassLoader, new Class<?>[] {openFilesHandlerClass}, this);
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        if (method.getName().equals("openFiles")) {
            boolean isJdk9 = SystemUtil.checkJvmVersion("9");
            final Class<?> openFilesEventClass =
                    Class.forName(isJdk9 ? "java.awt.desktop.FilesEvent"
