...
public class DeviceCustomList extends JList<DeviceListData> {
    ...
    class DeviceDataRenderer extends JPanel implements ListCellRenderer<DeviceListData> {
        ...
        @Override
        public Component getListCellRendererComponent(JList<? extends DeviceListData> list,
                DeviceListData value, int index, boolean isSelected, boolean cellHasFocus) {
            ...
            if (value != null) {
                ...
                if (value.getState() == DeviceListData.STATUS_INSTALLING) {
                    ...
                    if (!device.isOnline() || bundle.isNotInstallOptions()
                            || bundle.isImpossibleInstallOptions()
    ...
    private class CustomLabel extends JLabel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (osVersion != null) {
                centerString(g2d, new Rectangle(4, 4, 44, 44), osVersion, new Font(
                        getFont().getName(), Font.BOLD, (osVersion.length() < 4) ? 20 : 15));
            }
            if (isOnline) {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (index >= 0) {
                ...
                if (button != null && button.isEnabled()) {
                    ...
                    listRepaint(list, list.getCellBounds(index, index));
                    actionlistener
                            .actionPerformed(new ActionEvent(temp, 0, button.getActionCommand()));
                }
            }
        }
