...
public class DeviceUninstallAppAction extends AbstractDeviceAction {
    ...
    public DeviceUninstallAppAction(ApkActionEventHandler h) {
        super(h);
    }
            ...
            public void run() {
                ...
                for (IDevice device : devices) {
                    ...
                    if (!packageInfo.isSystemApp()) {
                        ...
                        int n = MessageBoxPool.show(owner,
                    ...
                    if (errMessage != null && !errMessage.isEmpty()) {
                        ...
                        EventQueue.invokeLater(new Runnable() {
                            public void run() {
                                MessageBoxPool.show(owner, MessageBoxPool.MSG_FAILURE_UNINSTALLED,
                                        errMsg);
                            }
                        });
                    } else {
