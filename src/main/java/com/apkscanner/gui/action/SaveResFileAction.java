...
public class SaveResFileAction extends AbstractApkScannerAction {
    ...
    public SaveResFileAction(ApkActionEventHandler h) {
        super(h);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (resObj.getURI() != null && "file".equals(resObj.getURI().getScheme())) {
    ...
    public File getSaveFile(Component component, String defaultFilePath) {
        ...
        // javax.swing.filechooser.FileNameExtensionFilter(RStr.LABEL_APK_FILE_DESC.get(),"apk"));

        if (jfc.showSaveDialog(component) != JFileChooser.APPROVE_OPTION) return null;
