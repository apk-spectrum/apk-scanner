...
public class CustomListRenderer extends DefaultListCellRenderer {
    ...
    // private static final ImageIcon crossIcon = new
    // ImageIcon(Resource.class.getResource("/icons/logo/base.png"));
    private static ImageIcon tipIcon = DefaultResImage.getImageIcon("/icons/logo/nougat.png");
    private static ImageIcon tipIcon1 = DefaultResImage.getImageIcon("/icons/logo/marshmallow.png");
    private static ImageIcon tipIcon2 = DefaultResImage.getImageIcon("/icons/logo/jelly_bean.png");
    ...
    private static class CustomLabel extends JLabel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            // g2d.drawImage ( tipIcon.getImage (), 5 + 13 - tipIcon.getIconWidth () / 2, 5 + 13 -
            // tipIcon.getIconHeight () / 2, null );
            g2d.drawImage(tipIcon.getImage(), 10 + 26 - tipIcon.getIconWidth() / 2,
                    10 + 26 - tipIcon.getIconHeight() / 2, null);

            if (selected) {
                // g2d.drawImage ( crossIcon.getImage (), getWidth () - 9 - 5 -
                // crossIcon.getIconWidth () / 2,
            ...
            switch (data.getNewMessages()) {
                ...
                case 1:
                    ...
                    g2d.drawImage(tipIcon2.getImage(), 10 + 26 - tipIcon2.getIconWidth() / 2,
                            10 + 26 - tipIcon2.getIconHeight() / 2, null);
                    break;
                case 2:
                    g2d.setPaint(Color.LIGHT_GRAY);
                    g2d.drawImage(tipIcon1.getImage(), 10 + 26 - tipIcon1.getIconWidth() / 2,
                            10 + 26 - tipIcon1.getIconHeight() / 2, null);
                    break;
                case 3:
                    g2d.setPaint(Color.GREEN);
                    g2d.drawImage(tipIcon2.getImage(), 10 + 26 - tipIcon2.getIconWidth() / 2,
