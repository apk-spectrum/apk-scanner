...
public class TestAAPT extends JDialog {
    ...
    TestAAPT() {
        ...
        // for(int j=0; j<1; j++) {
        // try {
        // arrayImage = ZipUtils.unimagezip(new
        // File("/home/leejinhyeong/Desktop/PMApplication-release.apk"), new
        // File("/home/leejinhyeong/Desktop/"), "icd_weather_14.png", false);
        //
        //
        //
        // } catch (Exception e) {
        ...
        for (int j = 0; j < 1; j++) {
            try {
                arrayImageFromfile = ZipUtils.unimagezipfromfile(
                        new File("/home/leejinhyeong/Desktop/PMApplication-release.apk"),
                        new File("/home/leejinhyeong/Desktop/"), "ic_launcher_hoppin.png", false);
