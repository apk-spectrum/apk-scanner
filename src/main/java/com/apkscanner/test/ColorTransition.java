        ...
        private class TransitionListener implements ActionListener {
            ...
            public void actionPerformed(ActionEvent e) {
                if (index > 100) {
                    ...
                    int r = (int) (background2.getRed() * index / 100.0
                            + background1.getRed() * (100 - index) / 100.0);
                    int g = (int) (background2.getGreen() * index / 100.0
                            + background1.getGreen() * (100 - index) / 100.0);
                    int b = (int) (background2.getBlue() * index / 100.0
                            + background1.getBlue() * (100 - index) / 100.0);
        ...
        for (Rgb rgb : Rgb.values()) {
            ...
            colorSlider.addChangeListener(new ChangeListener() {
                ...
                public void stateChanged(ChangeEvent e) {
                    ...
                    color = newValue;
                    propertyChangeSupport.firePropertyChange(COLOR, oldValue, newValue);
                }
            });
