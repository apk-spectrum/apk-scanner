...
public class Popup extends JFrame {
    ...
    public class JSwitchBox extends AbstractButton {
        ...
        public JSwitchBox(String trueLabel, String falseLabel) {
            ...
            double trueLenth =
                    getFontMetrics(getFont()).getStringBounds(trueLabel, getGraphics()).getWidth();
            double falseLenght =
                    getFontMetrics(getFont()).getStringBounds(falseLabel, getGraphics()).getWidth();
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2.setPaint(new GradientPaint(x, (int) (y - 0.1 * h), colorDark, x, (int) (y + 1.2 * h),
                    light));
            g2.fillRect(x, y, w, h);
            g2.setPaint(new GradientPaint(x, (int) (y + .65 * h), light, x, (int) (y + 1.3 * h),
                    colorDark));
