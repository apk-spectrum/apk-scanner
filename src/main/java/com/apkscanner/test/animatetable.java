...
public class animatetable extends JFrame {
    ...
    public animatetable() {
        ...
        final Object[][] data = new Object[][] {
                ...
                {RImg.INSTALL_WAIT.getImageIcon(), RImg.LOADING.getImageIcon()},

                // And here is the others pictures examples png and jpg
                {RImg.QUESTION.getImageIcon(), RImg.QUESTION.getImageIcon()}};
        final Object[] column =
                new Object[] {"Example image gif and png", "Example image gif and jpg"};
