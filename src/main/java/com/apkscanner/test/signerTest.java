...
//		Log.d(doc.html());
		...
		ApkVerifier verifier = new ApkVerifier.Builder(new File("/home/leejinhyeong/Desktop/auInitialSetting_v010414.apk")).build();
		  try {
			    Result result = verifier.verify();
			    
			    Log.d("" + result.isVerified() + result.isVerifiedUsingV1Scheme() + result.isVerifiedUsingV2Scheme());
