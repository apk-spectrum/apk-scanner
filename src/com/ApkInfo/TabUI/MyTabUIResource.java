...
public class MyTabUIResource extends JPanel{
    ...
    public void valueChanged(ListSelectionEvent event) {
    		...
    		String imagepath;
    		System.out.println("valueChanged : " + list.getSelectedIndex() + "   ImagePath : " + imageMap.get(nameList[list.getSelectedIndex()]));
    		
    		ImageIcon icon = imageMap.get(nameList[list.getSelectedIndex()]);
    ...
    private Map<String, ImageIcon> createImageMap(String[] list) {
        ...
        try {        	
           ...
           //map.put("Luigi", new ImageIcon(getScaledImage("/home/leejinhyeong/workspace/APKInfoDlgv2/res/sampleimage/drawable-xxxhdpi/artist_link_icon.png")));
            ...
            map.put("Mario", new ImageIcon(getScaledImage(new ImageIcon("/home/leejinhyeong/workspace/APKInfoDlgv2/res/sampleimage/drawable-xxxhdpi/button_dmarket_off.png"),32,32)));
            ...
            map.put("Bowser", new ImageIcon(getScaledImage(new ImageIcon("/home/leejinhyeong/workspace/APKInfoDlgv2/res/sampleimage/drawable-xxxhdpi/button_dmarket_off.png"),32,32)));
            map.put("Koopa", new ImageIcon(getScaledImage(new ImageIcon("/home/leejinhyeong/workspace/APKInfoDlgv2/res/sampleimage/drawable-xxxhdpi/button_dmarket_off.png"),32,32)));
            map.put("Princessa", new ImageIcon(getScaledImage(new ImageIcon("/home/leejinhyeong/workspace/APKInfoDlgv2/res/sampleimage/drawable-xxxhdpi/button_dmarket_off.png"),32,32)));
