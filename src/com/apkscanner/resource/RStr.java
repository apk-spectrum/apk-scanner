...
public enum RStr implements ResString<String>
{
	...
	ACTIVITY_COLUME_CLASS		("@activity_column_class"),
	ACTIVITY_COLUME_TYPE		("@activity_column_type"),
	ACTIVITY_COLUME_STARTUP		("@activity_column_startup"),
	ACTIVITY_COLUME_ENABLED		("@activity_column_enabled"),
	ACTIVITY_COLUME_EXPORT		("@activity_column_export"),
	ACTIVITY_COLUME_PERMISSION	("@activity_column_permission"),
