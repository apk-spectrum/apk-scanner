...
public enum RComp implements ResValue<RComp>
{
	...
	BTN_TOOLBAR_OPEN_CODE			(RStr.BTN_OPENCODE, RImg.TOOLBAR_OPENCODE.getImageIcon(TB.SubSize, TB.SubSize), RStr.BTN_OPENCODE_LAB),
	...
	MENU_TOOLBAR_INSTALLED_CHECK	(RStr.MENU_CHECK_INSTALLED, RImg.TOOLBAR_PACKAGETREE.getImageIcon(TB.SubSize, TB.SubSize)),
