...
public class ContentPanel extends JPanel
{
	...
	public ContentPanel(ActionListener listener) {
		...
		lodingPanel.add(new ImagePanel(RImg.APK_LOGO.getImageIcon(340,220)));
		lodingPanel.add(loadingMessageLable);
		lodingPanel.add(new ImagePanel(RImg.WAIT_BAR.getImageIcon()));
		...
		successPanel.add(new ImagePanel(RImg.RESULT_SUCCESS.getImageIcon(75,75)));
		...
		failPanel.add(new ImagePanel(RImg.RESULT_FAIL.getImageIcon(75,75)));
