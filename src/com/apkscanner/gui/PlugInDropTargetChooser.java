...
public class PlugInDropTargetChooser extends DropTargetChooser {
	...
	public PlugInDropTargetChooser(Listener listener) {
		...
		super.addDropTarget(DefaultTargetObject.DROPED_TARGET_APK_OPEN,
				RStr.BTN_OPEN.get(),
				RStr.APP_NAME.get(),
				RImg.APP_ICON.getImage(64,64),
				new Color(0.35546875f , 0.60546875f, 0.83203125f, 0.9f));
		super.addDropTarget(DefaultTargetObject.DROPED_TARGET_NEW_WIN,
				RStr.MENU_NEW.get(),
				RStr.APP_NAME.get(),
				RImg.TOOLBAR_MANIFEST.getImage(64,64),
	...
	@Override
	public void addDropTarget(Object dropTarget, String text, String title,
			Image image, Color background) {
		addDropTarget(dropTarget, text, title, image, background,
				externalToolVisible);
	}
