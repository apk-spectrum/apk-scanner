...
public class GraphicUtil {
	...
	public static void drawRoundrectText(Graphics page, int boxLeft, int boxTop, int width, int height, String text ) {
	...
	public static void drawTextRoundrect(Graphics page, int boxLeft, int boxTop, int fontsize, String text ) {
