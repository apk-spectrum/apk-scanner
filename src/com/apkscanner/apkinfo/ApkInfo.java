...
{
	public static final int APP_FEATURE_LAUNCHUR = 0x1;
	public static final int APP_FEATURE_STARTUP = 0x2;
	public static final int APP_FEATURE_DEBUGGABLE = 0x4;
	public static final int APP_FEATURE_SYSTEMUID = 0x8;
