...
public class ImgExtractorWrapper
{
	static public String[] extracte(String imgFilePath, String outFolderPath)
	{
		...
		String[] result = ConsolCmd.exec(new String[] {_RFile.BIN_IMG_EXTRACTOR_WIN.get(), imgFilePath, outFolderPath, "-i"}, false);
	...
	static public String getSuperblockInfo(String imgFilePath)
	{
		...
		String[] result = ConsolCmd.exec(new String[] {_RFile.BIN_IMG_EXTRACTOR_WIN.get(), imgFilePath, "-s"}, false);
	...
	static public String getLsInfo(String imgFilePath)
	{
		...
		String[] result = ConsolCmd.exec(new String[] {_RFile.BIN_IMG_EXTRACTOR_WIN.get(), imgFilePath, "-l"}, false);
