...
!define PROJECTNAMEANDVERSION "APK Scanner 2.9"
...
Section $(APP_NAME) Section1
	...
	File "${RELEASE_DIR}\data\build-master-target-product-security\*"
	SetOutPath "$INSTDIR\lib\"
	File "${RELEASE_DIR}\lib\*.jar"
	SetOutPath "$INSTDIR\plugin\"
	File "${RELEASE_DIR}\plugin\*"
	Delete "$INSTDIR\plugin\plugins.conf"
	SetOutPath "$INSTDIR\security\"
	File "${RELEASE_DIR}\security\*"
	SetOutPath "$INSTDIR\tool\"
	File "${RELEASE_DIR}\tool\*.jar"
	File "${RELEASE_DIR}\tool\*.png"
	SetOutPath "$INSTDIR\tool\dex2jar\"
	File "${RELEASE_DIR}\tool\dex2jar\*"
	SetOutPath "$INSTDIR\tool\dex2jar\lib\"
	File "${RELEASE_DIR}\tool\dex2jar\lib\*"
	SetOutPath "$INSTDIR\tool\jadx\"
	File "${RELEASE_DIR}\tool\jadx\*"
	SetOutPath "$INSTDIR\tool\jadx\bin\"
	File "${RELEASE_DIR}\tool\jadx\bin\*.bat"
	SetOutPath "$INSTDIR\tool\jadx\lib\"
	File "${RELEASE_DIR}\tool\jadx\lib\*"
	SetOutPath "$INSTDIR\tool\windows\"
	File "${RELEASE_DIR}\tool\windows\*"
...
Section Uninstall
	...
	Delete "$INSTDIR\tool\*"
	Delete "$INSTDIR\tool\dex2jar\*"
	Delete "$INSTDIR\tool\dex2jar\lib\*"
	...
	RMDir "$INSTDIR\tool\dex2jar\lib\"
	RMDir "$INSTDIR\tool\dex2jar\"
	RMDir "$INSTDIR\tool\"
